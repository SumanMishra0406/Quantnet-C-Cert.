/*
Testing operators created in the point, circle, and line class
Author: Suman Mishra
...
int main() {
    ...
    Point p_neg = -p1;
    cout << "Test negation (-p1): " << p_neg.ToString() << endl;

    // Testing the scaling operator
    Point p_scale = p1 * 5;
    cout << "Test scaling (p1 * 5): " << p_scale.ToString() << endl;

    // Test the addition operator
    Point p_sum = p1 + p2;
    cout << "Test addition (p1 + p2): " << p_sum.ToString() << endl;
    ...
    Point p_assign;
    p_assign = p1;
    cout << "Test assignment (p_assign = p1): " << p_assign.ToString() << endl;

    // Test the scale and assign operator
    p1 *= 3.0;
    cout << "Test scale and assignment (p1 *= 3.0): " << p1.ToString() << endl;
    ...
    cout << "Initial line (l1): " << l1.ToString() << endl;
    cout << "l2 = l1: " << l2.ToString() << endl;
    ...
    cout << "Assigned circle (c2 = c1): " << c2.ToString() << endl;
