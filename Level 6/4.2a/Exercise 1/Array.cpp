...
namespace suman
{
    namespace Containers
    {
        ...
        // Copy constructor
        template <typename T>
        Array<T>::Array(const Array<T> &source) // also need to use use Array<T> for param.
        {
        ...
        // Assignment operator
        template <typename T>
        Array<T> &Array<T>::operator=(const Array<T> &source) //need to use Array<T> for return type and scope
        {
            if (this == &source)
            {
                return *this;
